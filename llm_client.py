...
class LLMClient:
    ...
    def generate_text(self, prompt, retries=3, require_json=False):
        ...
        system_instructions = (
            ...
            "Jika sebuah tugas memerlukan penyelesaian CAPTCHA atau persetujuan finansial sensitif, tandai sebagai BLOCKED. "
            "Namun, jika tugas memerlukan verifikasi identitas (KYC) atau pengisian profil pribadi, JANGAN langsung diblokir. "
            "Sebaliknya, analisis apakah data yang diminta tersedia di Identity Vault. Jika ya, rencanakan untuk mengisi formulir tersebut secara otonom. "
